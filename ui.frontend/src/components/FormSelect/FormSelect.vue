<template>
  <section>
    <div>
      ...
      <select id="day" v-if="datetype == 'Day'" name="day">
    ...
    <div>
      <select id="month" v-if="datetype == 'Month'" name="month">
    ...
    <div>
      <select id="year" v-if="datetype == 'Year'" name="year">
...
export default {
  ...
  methods: {
    getValue () {
      ...
      if (this.inputmonth < month) {
        this.age = `${year - this.inputyear}`
      } else if (this.inputmonth > month) {
        this.age = `${year - this.inputyear - 1}`
      } else if (parseInt(this.inputmonth) === month) {
        if (this.inputday <= day) {
          this.age = `${year - this.inputyear}`
        } else {
          this.age = `${year - this.inputyear - 1}`
        }
